...
public class TestiniumCheckBox extends PageElementModel {
    private static final Log log = LogFactory.getLog(TestiniumCheckBox.class);

    public TestiniumCheckBox(selectorNames selectorName, String selectorValue) {
